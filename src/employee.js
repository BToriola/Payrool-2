...
const Employee = () => {
    ...
    useEffect(() => {
        localStorage.setItem('newEmployee', JSON.stringify(employeeDetails))
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9"><input type="text" name='jobid' value={jobid} onChange={e => {
